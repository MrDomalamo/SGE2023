...
if(@$aprovar_candidatura == 'ocultar'){
					...
					<div class="row">
									...
									<div class="form-group"> 
										...
										<select class="form-control sel2" name="recrutador" id="recrutador" required style="width:100%;"> 
											...
											if($nivel_usu == 'Diretor' || $nivel_usu == 'Recrutador'){
												$query = $pdo->query("SELECT * FROM funcionarios where bairro = '$provincia_func' and cargo = '$id_cargo' order by id asc");
											}else{
						...
						<div class="col-md-6">						
									<div class="form-group"> 
										...
										<input type="date" class="form-control" name="data_aprovacao" id="data_aprovacao" value="<?php echo date('Y-m-d') ?>"> 
									</div>						
								</div>

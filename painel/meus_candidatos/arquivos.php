...
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, descricao = '', data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Candidatos', id_reg = '$id'");

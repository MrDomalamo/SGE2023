			...
			<div class="modal-header">
				...
				<div class="modal-body">			
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						...
						<div class="col-md-6">							
							<span><b>Percentagem BuyCarInMoz </b></span>
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						<div class="col-md-6">							
							<span><b>Data de Pagamento: </b></span>
				...
				<form id="form-baixar" method="post">
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">Multa em MNZ</label>
							...
							<div class="col-md-4">
								<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">Júros em MNZ</label>
								...
								<div class="col-md-4">
								<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">Desconto em MNZ</label>

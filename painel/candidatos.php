...
if(@$candidatos == 'ocultar'){
 ...
 <button onclick="inserir()" type="button" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Candidato</button>

 <!--<button type="button" class="btn btn-primary btn-flat btn-pri"><li class="<?php echo @$rel_candidatos ?>"><a href="#" data-toggle="modal" data-target="#RelCad" style="color:#fff"><i class="fa fa-plus" aria-hidden="true"></i> PDF</a></li></button>-->

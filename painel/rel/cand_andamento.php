...
<body>	
	...
	<?php } ?>
	<div class="edm" ><B>Relatório Candidaturas Em Andamento</B></div>
	<br>
	...
	<div class="mx-2" style="padding-top:10px; ">
		...
		<?php 
			...
			if(($genero == "") && ($idade == "")){
				$query = $pdo->query("SELECT * FROM candidaturas where estado LIKE'Em Curso' and (data_cad >= '$dataInicial' and data_cad <= '$dataFinal')  ORDER BY id desc");
			}elseif(($genero == "Masculino" || $genero == "Feminino") && ($idade == "")){
				$query = $pdo->query("SELECT * FROM candidaturas where estado LIKE 'Em Curso' and (data_cad >= '$dataInicial' and data_cad <= '$dataFinal') and genero LIKE '$genero'  ORDER BY id desc");
			}elseif(($genero == "") && ($idade >= 18)){
				$query = $pdo->query("SELECT * FROM candidaturas where estado LIKE 'Em Curso' and (data_cad >= '$dataInicial' and data_cad <= '$dataFinal') and idade LIKE '$idade'  ORDER BY id desc");
			}elseif(($genero == "Masculino" || $genero == "Feminino") && ($idade >= 18)){
				$query = $pdo->query("SELECT * FROM candidaturas where estado LIKE 'Em Curso' and (data_cad >= '$dataInicial' and data_cad <= '$dataFinal') and idade LIKE '$idade' and genero LIKE '$genero'  ORDER BY id desc");
			}

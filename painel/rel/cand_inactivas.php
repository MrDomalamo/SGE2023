...
<body>	
	...
	<?php } ?>
	<div class="edm" ><B>Relatório Candidaturas Inactivas</B></div>
	<br>
	...
	<div class="mx-2" style="padding-top:10px; ">
		...
		<?php 
			...
			$query = $pdo->query("SELECT * FROM candidaturas where ativo != 'Sim' and data_cad >= '$dataInicial' and data_cad <= '$dataFinal' ORDER BY id desc");

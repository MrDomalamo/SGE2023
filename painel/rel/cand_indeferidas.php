...
<body>	
	...
	<?php } ?>
	<div class="edm" ><B>Relatório Candidaturas Indeferidas</B></div>
	<br>
	...
	<div class="mx-2" style="padding-top:10px; ">
		...
		<?php 
			...
			$query = $pdo->query("SELECT * FROM candidaturas where estado = 'Indeferido' and data_cad >= '$dataInicial' and data_cad <= '$dataFinal' ORDER BY id desc");
			...
			<small><small>
				<section class="area-tab" style="background-color: #D2691E;">
					...
					<div class="linha-cab" style="padding-top: 5px; color: #000;">
						...
						<div class="coluna" style="width:14%; "><b>Instituição</b></div>
						<div class="coluna" style="width:12%"><b>Curso</b></div>
						<div class="coluna" style="width:12%"><b>Género</b></div>
						<div class="coluna" style="width:15%" ><b>Telefone</b></div>
						<div class="coluna" style="width:15%" ><b>Estagio</b></div>
						<div class="coluna" style="width:12%" ><b>Obs</b></div>
		...
		$data_cadF = implode('/', array_reverse(explode('-', $data_cad)));
					...
					<section class="area-tab" style="padding-top:5px">					
						<div class="linha-cab">
							...
							<div class="coluna " style="width:14%"><?php echo $nome_instituicoes ?></div>


							<div class="coluna" style="width:12%"><?php echo $nome_curso?></div>


							<div class="coluna" style="width:12%"><?php echo $genero_candidato ?></div>

							<div class="coluna" style="width:15%" ><?php echo $telefone_candidato?></div>

							<div class="coluna" style="width:15%" ><?php echo $estado ?></div>

							<div class="coluna" style="width:12%" ><?php echo $descricao ?></div>

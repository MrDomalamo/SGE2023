...
<small>
HTML;
$query = $pdo->query("SELECT * FROM instituicoes ORDER BY id desc");
...
HTML;
	for($i=0; $i < $total_reg; $i++){
		...
		<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$curso}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>

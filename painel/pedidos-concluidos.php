...
<div class="modal fade" id="modalMostrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
	...
	<div class="modal fade" id="modalContratoVenda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="tituloModal">Preencher Contrato - <span id="nome-vistoria"> </span></h4>
					<button id="btn-fechar-vistoria" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form id="form-vistoria" method="post" action="rel/contrato_venda_class.php" target="_blank">
					<div class="modal-body">

					
						<div class="form-group"> 
							<label>Texto do Contrato </label> 
							<textarea name="area" id="area" class="textareagh"> </textarea>
						</div>

...
if($nivel_usuario == 'Recrutador'){
	$query = $pdo->query("SELECT * FROM candidaturas where recrutador = '$id_usuario' or recrutador = '0' and bairro = '$provincia_usu' ORDER BY id desc");
}else{

...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Candidaturas Indeferidas</title>s
	<head>
	<body> 
		<?php
		
		$arquivo = 'Candidaturas Indeferidas.xls';
...
if($nivel_usuario == 'Recrutador'){
	$query = $pdo->query("SELECT * FROM candidaturas where estado = 'Inferido' and recrutador = '$id_usuario' and bairro = '$provincia_usu' ORDER BY id desc");
}else{
	$query = $pdo->query("SELECT * FROM candidaturas where estado = 'Inferido' ORDER BY id desc");
}
...
if($total_reg > 0){
	...
	<tr>
		 <td colspan="7" style="text-align: center; font-size:medium; background: #696969;"><b>Candidaturas</b></tr>
		 </tr>
	<thead> 
	<tr> 
	<th style="background: #ff6900;">Nome</th>
	<th class="esc" style="background: #ff6900;">Instituicao</th> 
	<th class="esc" style="background: #ff6900;">Curso</th> 
	<th class="esc" style="background: #ff6900;">Genero</th>
	<th class="esc" style="background: #ff6900;">Telefone</th>	  
	<th class="esc" style="background: #ff6900;">Estagio</th>
	<th class="esc" style="background: #ff6900;">Obs</th>
	</tr> 
	</thead> 
	<tbody> 
HTML;

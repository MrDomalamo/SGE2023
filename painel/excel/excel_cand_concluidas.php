...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Candidaturas Concluídas</title>
	<head>
	<body> 
		<?php
...
if($nivel_usuario == 'Recrutador'){
	$query = $pdo->query("SELECT * FROM candidaturas where estado = 'Concluido' and recrutador = '$id_usuario' and bairro = '$provincia_usu' ORDER BY id desc");
}else{
	$query = $pdo->query("SELECT * FROM candidaturas where estado = 'Concluido' ORDER BY id desc");
}
...
if($total_reg > 0){
	...
	<tr>
		 <td colspan="9" style="text-align: center; font-size:medium; background: #696969;"><b>Candidaturas Concluídas</b></tr>
		 </tr>
	<thead> 
	<tr> 

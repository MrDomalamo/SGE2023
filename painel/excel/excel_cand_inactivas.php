...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Candidaturas Inactivas</title>
	<head>
	<body> 
		<?php
		
		$arquivo = 'Candidaturas Concluidas.xls';
...
if($nivel_usuario == 'Recrutador'){
	$query = $pdo->query("SELECT * FROM candidaturas where ativo = 'Não' and recrutador = '$id_usuario' and bairro = '$provincia_usu' ORDER BY id desc");
}else{
...
if($total_reg > 0){
	...
	<tr>
		 <td colspan="7" style="text-align: center; font-size:medium; background: #696969;"><b>Candidaturas Concluídas</b></tr>
		 </tr>
	<thead> 
	<tr> 
